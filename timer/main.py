...
class Game:
    ...
    def mainLoop(self):
        ...
        pygame.draw.line(gameContext.screen, (0, 0, 0), (100, 100), (100+200, 100), 2)
        pygame.draw.line(gameContext.screen, (0, 0, 0), (100+200, 100), (100+200, 100+300), 2)
        pygame.draw.line(gameContext.screen, (0, 0, 0), (100+200, 100+300), (100, 100+300), 2)
        pygame.draw.line(gameContext.screen, (0, 0, 0), (100, 100+300), (100, 100), 2)
        text_surface = font.render("Time", True, (0, 0, 0)) 
        gameContext.screen.blit(text_surface, (300+5, 40))  
